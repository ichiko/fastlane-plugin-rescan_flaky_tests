...
Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-rescan_flaky_tests'
  spec.version       = Fastlane::RescanFlakyTests::VERSION
  spec.author        = 'Ichiko Moro'
  ...
  spec.add_development_dependency 'fastlane', '>= 2.70.2'
end
